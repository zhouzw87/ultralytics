...
if __name__ == "__main__":
    ...
    parser.add_argument('--cocodir', type=str, default="/disk1/PeopleCar/v4/" , help="coco directory")
    ...
    parser.add_argument('--exportweight', type=str, default='./vehicle1.4/train2/weights/last.pt',help='initial weight patsh')
    ...
    parser.add_argument('--rknn', type=bool,default=False, help='export rknn onnx')
    parser.add_argument('--transout', type=bool,default=False, help='export onnx for onnxruntime')

    parser.add_argument('--export', type=bool, default=True, help='Do Export weight to onnx file ...')
    ...
    if args.export:
        run_export(args.exportweight, args.save, args.size, args.dynamic,
                   args.noqadd, args.end2end, args.simplify,args.graphsurgeon,args.ort, args.rknn, args.transout)
        exit()
    elif args.finetune:
        run_qat(
